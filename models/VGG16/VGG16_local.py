...
# WEIGHTS_PATH_NO_TOP = '/data/data_laurent/models/pretrained/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5'

PATH_VGG16_WEIGHTS = config.PATH_VGG16_WEIGHTS
  ...
  if weights == 'imagenet':
    ...
    if include_top:
      ...
      weights_path = get_file(
          ...
          cache_subdir='models')
    """
    model.load_weights(PATH_VGG16_WEIGHTS)
    if K.backend() == 'theano':
